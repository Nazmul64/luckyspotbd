...
class FrontendDashboardController extends Controller
{
    public function frontend()
    {
         $package_show = Lottery::where('status', 'active')
            ...
            ->get();
        $total_buyer = Userpackagebuy::where('user_id', Auth::id())->count();
        ...
        return view('frontend.dashboard.index',compact('total_deposite','total_balance','deposite_history','package_show','total_buyer'));
    }
}
