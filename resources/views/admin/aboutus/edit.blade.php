            ...
            <form action="{{ route('aboutus.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="title" class="form-control"
                           placeholder="শিরোনাম লিখুন" value="{{ old('title', $about->title) }}">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="4"
                              placeholder="বর্ণনা লিখুন">{{ old('description', $about->description) }}</textarea>
                    @error('description')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="new_photo" id="photo" class="form-control">
                    @error('photo')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                 <div class="mb-3">
                    <label for="photo" class="form-label">Old (Photo)</label><br>
                   <img src="{{ asset($about->photo) }}"alt="Preview Image" width="100">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <img id="previewImg"
                         src="{{ $about->photo ? asset('uploads/aboutus/' . $about->photo) : asset('uploads/aboutus/no-image.png') }}"
...
<script>
    ...
    photoInput.addEventListener('change', function() {
        ...
        if (file) {
            ...
            previewImg.setAttribute('src', "{{ $about->photo ? asset('uploads/aboutus/' . $about->photo) : asset('uploads/aboutus/no-image.png') }}");
        }
    });
</script>
@endsection
