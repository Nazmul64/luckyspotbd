...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('howtoticket.store') }}" method="POST">
                @csrf
                        ...
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description[{{ $code }}]"
                                          ...
                                          rows="3">{{ old("description.$code") }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="sign_up_first_login[{{ $code }}]"
                                          class="form-control"
                                          rows="2">{{ old("sign_up_first_login.$code") }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="complete_your_profile[{{ $code }}]"
                                          class="form-control"
                                          rows="2">{{ old("complete_your_profile.$code") }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="choose_a_ticket[{{ $code }}]"
                                          class="form-control"
                                          rows="2">{{ old("choose_a_ticket.$code") }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('sign_up_first_login_icon', 'fas fa-user-plus') }}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('complete_your_profile_icon', 'fas fa-user-check') }}">
                        <small class="text-muted">FontAwesome class</small>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('choose_a_ticket_icon', 'fas fa-ticket-alt') }}">
                        <small class="text-muted">FontAwesome class</small>
                    </div>
                </div>
