{{-- resources/views/admin/whychooseustickets/create.blade.php --}}
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <h5 class="mb-3 text-uppercase fw-bold">
                <i class="bi bi-plus-circle"></i> Add New Why Choose Us Item
            </h5>

            <form action="{{ route('whychooseustickets.store') }}" method="POST" id="whyChooseForm">
                @csrf
                ...
                <div class="alert alert-info">
                    <i class="bi bi-info-circle"></i> This will be the main heading for the "Why Choose Us" section.
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="main_description_en"
                            ...
                            rows="4"
                            placeholder="Write main description in English...">{{ old('main_description_en') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="main_description_bn"
                            ...
                            rows="4"
                            placeholder="বাংলায় প্রধান বর্ণনা লিখুন...">{{ old('main_description_bn') }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="description_en"
                            ...
                            rows="4"
                            placeholder="Write description in English...">{{ old('description_en') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="description_bn"
                            ...
                            rows="4"
                            placeholder="বাংলায় বর্ণনা লিখুন...">{{ old('description_bn') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <div id="iconPreview" class="mt-3 p-3 border rounded" style="display: none;">
                        <label class="form-label fw-semibold">Icon Preview:</label>
